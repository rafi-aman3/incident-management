...
- **Build status:** see [`docs/BUILD_STATUS.md`](docs/BUILD_STATUS.md) for the full phase-by-phase shipping log. Current state in one line: **V1 demo feature-complete on `main` (all 5 modules shipped 2026-05-06)**; Phase 6 frontend polish in progress — 6a/6b/6c/6d/6e/6f/6g/6h shipped + 6k/6l (sidebar + topbar) shipped, **6i–6j queued** (Planner → Admin); **Phase 11 org admin console complete** — 11a sites + 11b members shipped 2026-05-07 (PRs #14, #15); 11c roles + invitations + 6d CAPA polish shipped 2026-05-08 (PRs #16, #17); 6e Reports polish shipped 2026-05-08 (PR #18); 6f Templates polish shipped 2026-05-08 (PR #19); 6g Inspections polish shipped 2026-05-08 (PR #20); 6h Resources polish shipped 2026-05-08 (PR #21). Every org-admin task that previously required the Supabase SQL editor now has a UI path. Every runtime change goes through a feature branch + PR per `.claude/rules/github-workflow.md`; direct push to `main` is reserved for doc-only updates the user explicitly asks for.
